...
public class BookDAO {
    ...
    private static void initEmps() {
        Book book1 = new Book("1","Sherlock", "Doil", Genre.ROMANCE);
        Book book2 = new Book("2","WheelOfTime", "Djordan", Genre.FANTASY);
        Book book3 = new Book("3","Inferno", "Brown", Genre.FANTASY);
