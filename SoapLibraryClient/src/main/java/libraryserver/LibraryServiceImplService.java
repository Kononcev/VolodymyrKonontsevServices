 ...
 * 
 */
@WebServiceClient(name = "LibraryServiceImplService", targetNamespace = "http://libraryserver/", wsdlLocation = "http://localhost:4444/libraryservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LIBRARYSERVICEIMPLSERVICE_QNAME = new QName("http://libraryserver/", "LibraryServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:4444/libraryservice?wsdl");
    ...
    public LibraryServiceImpl getLibraryServiceImplPort() {
        return super.getPort(new QName("http://libraryserver/", "LibraryServiceImplPort"), LibraryServiceImpl.class);
    }
     ...
     */
    @WebEndpoint(name = "LibraryServiceImplPort")
    public LibraryServiceImpl getLibraryServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://libraryserver/", "LibraryServiceImplPort"), LibraryServiceImpl.class, features);
    }
